    ...
    <div className="relative ml-3">
      ...
      {open && (
        <div className="absolute right-0 z-10 mt-2 w-48 bg-gray-800 rounded-md shadow-lg py-1">
          <Link to="/app/profile" className="block px-4 py-2 text-sm hover:bg-gray-700">Your Profile</Link>
          <Link to="app/settings" className="block px-4 py-2 text-sm hover:bg-gray-700">Settings</Link>
...
export default function Navbar({ activePage = '', searchQuery, onSearch, showSearch = true }) {
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block md:ml-6">
              <div className="flex space-x-2">
                <NavItem to="/app/home" isActive={activePage === 'home'}>Home</NavItem>
                <NavItem to="/app/series" isActive={activePage === 'series'}>Series</NavItem>
                <NavItem to="/app/films" isActive={activePage === 'film'}>Film</NavItem>
                <NavItem to="/app/mylist" isActive={activePage === 'mylist'}>My List</NavItem>
              </div>
            </div>
          </div>
