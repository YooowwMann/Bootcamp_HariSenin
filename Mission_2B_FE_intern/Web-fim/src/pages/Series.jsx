...
const Series = ({searchQuery, onSearch}) => {
  const [series] = useState(popularSeries);
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F] text-white">
      ...
      <div className="px-10 py-12 space-y-12">
        <SeriesRow title="Melanjutkan Tonton Series"
          data={safeSlice(popularSeries, 5, 12)}
        />

        <SeriesRow title="Series Persembahan Chill"
          data={safeSlice(popularSeries, 0, 40)}
        />

        <SeriesRow title="Top Rating Series Hari Ini"
          data={
            popularSeries
        ...
        <SeriesRow title="Series Trending"
          data={safeSlice(popularSeries, 15, 29)}
        />

        <SeriesRow title="Rilis Baru"
          data={
            popularSeries
